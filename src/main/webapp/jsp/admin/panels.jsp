<%@page import="com.projectbru.demo.model.AdminBean"%>
...
%>
<%
	bean = (AdminBean) request.getSession().getAttribute("LoginAdmin");
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				<div class="profile-usertitle-name"><%=bean.getAdminName()%></div>
